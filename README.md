...
* Candidate Registration (Sign Up)
* Secure Login Authentication (3 login attempts)
* Automatic User ID & Password Generation
* Input Validation (DOB & Mobile Number)
